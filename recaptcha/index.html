                ...
                <form id="contact-form" method="post" action="contact.php" role="form">
                    ...
                    <div class="controls">
                        ...
                        <div class="form-group">
                            ...
                            <textarea id="form_message" name="message" class="form-control" placeholder="Παρακαλώ εισάγετε το μήνυμα σας. *" rows="4" required="required"
                                data-error="Παρακαλώ εισάγετε το μήνυμα σας."></textarea>
                            <div class="help-block with-errors"></div>
                        </div>


                        <div class="form-group">
                            <div class="g-recaptcha" data-sitekey="6LcR2oIUAAAAAOELXXd9YvQQNPd1_LzMAsusyEHM" data-callback="verifyRecaptchaCallback" data-expired-callback="expiredRecaptchaCallback"></div>

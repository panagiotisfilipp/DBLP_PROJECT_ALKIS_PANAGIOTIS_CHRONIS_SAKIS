      ...
      <div class="collapse navbar-collapse" id="navbarSupportedContent-4">
        <ul class="navbar-nav ml-auto">
          <li class="nav-item active">
            <a class="nav-link" href="chr-index.php">αρχικη</a>
          </li>
          <li class="nav-item">
          ...
          <li class="nav-item">
            <a class="nav-link" href="">εισοδοσ / προσθηκη</a>
          </li>
...
<div class="container" style="margin-top:50px" >
  <div class="row">
    <div align="center" class="col-sm-4">
	  <h4><b>Σ.Τ.ΕΦ<br><hr class="d-sm-none"><p>Τμήμα Μηχανικών Πληροφορικής<br><hr class="d-sm-none"><p>Π.Μ.Σ.<br> Ευφυείς Τεχνολογίες Διαδικτύου</b></h4><p>
	
	  <h5><U>Μάθημα: </U></h5>
      <h5>Μηχανική Λογισμικού για Διαδικτυακές Εφαρμογές</h5>
	...
	<hr class="d-sm-none"><p>
	<hr class="d-sm-none"><p>
	  <h4><b>Σχετικά με την DBLP</b></h4><p>

      <div ><img src="https://dblp.uni-trier.de/img/logo.320x120.png"alt="dblp-logo" width="160" height="60"  /></div>
      <p>Αυτή η υπηρεσία παρέχει ανοικτές βιβλιογραφικές πληροφορίες σε μεγάλα επιστημονικά περιοδικά και διαδικασίες. Το dblp είναι μια κοινή υπηρεσία του Πανεπιστημίου του Trier και του Schloss Dagstuhl. Για περισσότερες πληροφορίες, ανατρέξτε στο F.A.Q..</p>
    ...
    <div align="center" class="col-sm-8">
      <p>
      <h2><b>Εφαρμογή αναζήτησης και επεγεργασίας συγγραμάτων</b></h2>
      <br><br><br>
	  <p>
	   <img src="images/ateithe.jpg" class="img-responsive" alt="ΑΤΕΙ ΘΕΣΣΑΛΟΝΙΚΗΣ"> <br><br>
      
      <p><h5>ΑΤΕΙΘ - ΝΟΕΜΒΡΙΟΣ-ΔΕΚΕΜΒΡΙΟΣ 2018</h5></p>
    ...
    <section class="footer-bottom">
      <div class="container">
        <div class="row">
          <div class="col-md-12">
            <ul>
              <li><a href="chr2-th-index.php">Αρχική Σελίδα</a></li>
              <li class="hidden">/</li>
              <li><a href="chr-about.html">Ποιοι ήμαστε</a></li>
              <li class="hidden">/</li>
              <li><a href="chr-dblp.php">Το DBLP API</a></li>
              <li class="hidden">/</li>
              <li><a href="chr-manual.php">Οδηγίες για την Εφαρμογή</a></li>
              <li class="hidden">/</li>
            </ul>
          </div>
          <div class="col-md-12">

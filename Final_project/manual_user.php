...
θα υπάρχει RSS FEED , το οποίο θα περιέχει συνδέσμους με τις
τελευταίες αναρτημένες δημοσιεύσεις  άλλων
...
Ο επισκέπτης χρήστης από το μενού «Αρχική» θα έχει την δυνατότητα να αναζητήσει και να εμφανίσει τα άρθρα κάποιου από τα μέλη του προσωπικού του τμήματος
	Μηχανικών Πληροφορικής του ΑΤΕΙΘ, σελιδοποιημένα ανά πεντάδες, για 	ευκολότερη προβολή τους.<br />
Τα
...
δημοσιεύσης (εικονίδιο που πατώνταςτο

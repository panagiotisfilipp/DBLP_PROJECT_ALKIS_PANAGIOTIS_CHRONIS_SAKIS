...
<meta charset="utf-8"/>
<head>
    <title>Αναλυτική Εμφάνιση Δημοσιεύσεων Από Χρήστη</title>
...
<div class="row">
 <div  align="center" class="col-sm-12">
      <h2 align="center" style="margin-bottom:24px">Αναλυτική Εμφάνιση Δημοσιεύσεων Από Χρήστη</h2>
...
<!-- Εμφάνιση Δημοσιεύσεων -->
 <div class="table-responsive">
   ...
   /* Ερώτημα που επιστρέφει το πλήθος εγγραφών στο πίνακα papers */
	     $query_dblp="select * from papers where papers.url_id like  'MURL#%' ";
...
/* Ορισμός εγγραφών ανά σελίδα */	
	...
	$k=($page_cur-1)*$dis;	
     ...
     //Εμφάνιση εγγραφών συγγραμμάτων του χρήστη////			 
      $query = "SELECT * FROM papers where papers.url_id like  'MURL#%' order by type ASC limit $k, $dis"; 

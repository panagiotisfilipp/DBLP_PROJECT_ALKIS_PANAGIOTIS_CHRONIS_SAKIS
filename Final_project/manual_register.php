...
Με την εγγραφή στον διαδικτυακό τόπο ο χρήστης μπορεί να κάνει login στην εφαρμογή, οπότε και  θα βλέπει πάλι την εισαγωγική οθόνη περιήγησης στην εφαρμογή.<br>
 ...
 Η αρχική οθόνη θα περιλαμβάνει ένα λογότυπο, μία μπάρα πλοήγησης και ένα υποσέλιδο. Στην δεξιά πλευρά της σελίδας θα υπάρχει RSS FEED, το οποίο θα περιέχει συνδέσμους με τα τελευταία αναρτημένα συγγράμματα  άλλων επιστημονικών περιοδικών. Ο χρήστης θα μπορεί πατώντας στους συνδέσμους να τα μεταβεί σε αυτά.  <br>
...
Από το μενού «<strong><u>Αρχική</u></strong>» θα έχει την δυνατότητα να αναζητήσει και να εμφανίσει τα άρθρα κάποιου από τα μέλη του προσωπικού του τμήματος Μηχανικών Πληροφορικής του ΑΤΕΙΘ, σελιδοποιημένα ανά δεκάδες, για ευκολότερη προβολή τους.<br>
...
<br>
Εννοείτε πως υπάρχει η δυνατότητα συνδυασμού των παραπάνω κριτηρίων με ανάλογα αποτελέσματα. Π.χ. αν δεν βάλουμε κανένα όνομα μέλους προσωπικού του τμήματος Μηχανικών Πληροφορικής του ΑΤΕΙΘ και χρησιμοποιήσουμε κάποιο από τα υπόλοιπα κριτήρια, τότε το API θα μας εμφανίσει  το μέγιστο 1000 αποτελέσματα (περιορισμός API) οποιουδήποτε συγγραφέα  γνωρίζει που δεν είναι μέλος του προσωπικού του τμήματος Μηχανικών Πληροφορικής του ΑΤΕΙΘ. Αν ο χρήστης δεν καθορίσει τύπο δημοσίευσης, αλλά μόνο λέξη κλειδί τότε το API θα επιστέψει τα πρώτα 1000 αποτελέσματα που θα ανακτήσει με βάση την λέξη κλειδί και ασχέτως τον τύπο δημοσίευσης. Αν με βάση τα κριτήρια που ορίσει ο χρήστης δεν υπάρχουν κατάλληλες εγγραφές στο API DBLP θα εμφανίζεται κατάλληλο μήνυμα που θα ενημερώνει το χρήστη για μη ύπαρξη τέτοιων συγγραμμάτων.<br>

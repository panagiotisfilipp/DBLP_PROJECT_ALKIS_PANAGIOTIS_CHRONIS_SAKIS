...
///alert admin gia ekkatharisi///
function CustomAlert_delete_main(){
    this.on = function(dialog){
        var winW = window.innerWidth;
        var winH = window.innerHeight;
        var dialogoverlay = document.getElementById('dialogoverlay');
        ...
        document.getElementById('dialogboxhead').innerHTML = "Μήνυμα Ενημέρωσης";
        document.getElementById('dialogboxbody').innerHTML = dialog;
        document.getElementById('dialogboxfoot').innerHTML = '<button onclick="alert_main.off()">OK</button>';
    }
	this.off = function(){
		document.getElementById('dialogbox').style.display = "none";
		document.getElementById('dialogoverlay').style.display = "none";
...
var alert_main = new CustomAlert_delete_main();

...
<?php
	...
	function insertEmployee($params) {
		$data = array();;
		$sql = "INSERT INTO `users` (username, password, email) VALUES('" . $params["username"] . "', '" . $params["password"] . "','" . $params["email"] . "');  ";
	...
	function updateEmployee($params) {
		$data = array();
		//print_R($_POST);die;
		$sql = "Update `users` set username = '" . $params["edit_username"] . "', password='" . $params["edit_password"]."', email='" . $params["edit_email"] . "' WHERE user_id='".$_POST["edit_id"]."'";
	...
	function deleteEmployee($params) {
		$data = array();
		//print_R($_POST);die;
		$sql = "delete from `users` WHERE user_id='".$params["id"]."'";
